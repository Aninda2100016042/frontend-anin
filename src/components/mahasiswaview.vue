  ...
  export default {
    ...
    methods: {
      ...
      async createMahasiswa() {
        try {
          const response = await axios.post('https://backend-anin.vercel.app/mahasiswa', this.mahasiswaData, {
      ...
      async getAllMahasiswa() {
        try {
          const response = await axios.get('https://backend-anin.vercel.app/mahasiswa', {
            headers: { Authorization: `Bearer ${this.getToken()}` }
          });
      ...
      async getMahasiswaById(id) {
        try {
          const response = await axios.get(`https://backend-anin.vercel.app/mahasiswa/${id}`, {
            headers: { Authorization: `Bearer ${this.getToken()}` }
          });
      ...
      async updateMahasiswa() {
        try {
          const response = await axios.put(`https://backend-anin.vercel.app/mahasiswa/${this.selectedMahasiswa._id}`, this.selectedMahasiswa, {
            headers: { Authorization: `Bearer ${this.getToken()}` }
          });
      ...
      if (confirmed) { 
        try {
          await axios.delete(`https://backend-anin.vercel.app/mahasiswa/${id}`, {
            headers: { Authorization: `Bearer ${this.getToken()}` }
          });
